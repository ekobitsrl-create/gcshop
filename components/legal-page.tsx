...
export function LegalPage({ topic }: { topic: keyof typeof legalContent }) {
  ...
  return <div className="commerce-shell"><CommerceHeader /><main lang="it">
    <header className="commerce-hero company-hero store-help-hero"><p className="commerce-kicker">LCS / Informazioni · Italiano</p><h1>{copy.title}</h1><p className="commerce-hero-copy">{copy.intro}</p></header>
