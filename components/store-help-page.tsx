...
export async function StoreHelpPage({ topic }: { topic: "size" | "payment" }) {
  ...
  return <div className="commerce-shell">
    <CommerceHeader />
    <main>
      <header className="commerce-hero company-hero store-help-hero"><p className="commerce-kicker">LCS / Client service</p><h1>{copy.title}</h1><p className="commerce-hero-copy">{copy.intro}</p></header>
